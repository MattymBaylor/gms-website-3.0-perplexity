...
The way it stays sub-three-seconds when twenty calls land at once is that no single model is doing everything — [a router hands off to a qualifier, who hands off to a scheduler, who hands off to a texter](/seinfeld-hq), each specialized for one piece of the call. Speed is a property of the architecture, not of a bigger model.
