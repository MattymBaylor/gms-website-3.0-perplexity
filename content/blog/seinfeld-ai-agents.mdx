...
<aside className="my-16 border-l-4 border-accent bg-accent/5 px-6 py-6 md:px-10 md:py-8">
  <p className="text-xl md:text-2xl font-medium italic leading-snug text-ink">
    "Once you stop treating AI like a chatbot and start treating it like a team, everything changes."
  </p>
</aside>
...
<aside className="my-16 border-l-4 border-accent bg-accent/5 px-6 py-6 md:px-10 md:py-8">
  <p className="text-xl md:text-2xl font-medium italic leading-snug text-ink">
    "One homeowner. Fifteen agents. One seamless experience."
  </p>
</aside>
...
<aside className="my-16 border-l-4 border-accent bg-accent/5 px-6 py-6 md:px-10 md:py-8">
  <p className="text-xl md:text-2xl font-medium italic leading-snug text-ink">
    "The cast is fun. The system underneath is what actually makes money."
  </p>
</aside>
...
<aside className="my-16 border-l-4 border-accent bg-accent/5 px-6 py-6 md:px-10 md:py-8">
  <p className="text-xl md:text-2xl font-medium italic leading-snug text-ink">
    "The system is built to complete tasks, not talk about them."
  </p>
</aside>
