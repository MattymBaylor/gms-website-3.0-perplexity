 ...
 * Single back plate (no outer title/lead — iframe already carries its own).
 * Solid night bg + cyan rim via box-shadow so corners stay dark.
 */
    ...
    >
      <div className="container-wide">
        <div className="relative">
          ...
          {/* One plate only — solid night bg, cyan rim (no stacked white borders) */}
